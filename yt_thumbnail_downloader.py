...
#banner art
banner = pyfiglet.figlet_format('''THUMBNAIL DOWNLOADER''')
print(banner)

print(f"{fontcolors.WARNING} #####> AUTHOR : Sumit <##### {fontcolors.ENDC}")

#instructions
print(f"\n{fontcolors.GREEN}*** USAGE INSTRUCTIONS ***{fontcolors.ENDC}")
...
print(f"\n{fontcolors.GREEN}*** SELECT RESOLUTION ***{fontcolors.ENDC}")
...
def msg():
	print(f"\n{fontcolors.GREEN} Downloaded Successfully...{fontcolors.ENDC}","saved as",local_image_filename)
